...
using Babrat.Server.Gateway.Deployment;

namespace Babrat.Server.Gateway;
...
public class Program
{
    public static int Main(string[] args)
    {
        ...
        try
        {
            ...
            Log.Logger?.Information("Dependency container has been initialized and composition root has been set up.");
